...
export default function TopNav() {
  return (
    <header className="h-20 bg-aurum-dark/80 backdrop-blur-md border-b border-white/5 flex items-center justify-between px-8 sticky top-0 z-30 ml-64">
      {/* Page Title / Search */}
      <div className="flex items-center w-full max-w-md bg-aurum-panel rounded-full px-4 py-2 border border-white/5 focus-within:border-aurum-gold/50 transition-colors">
      ...
      <div className="flex items-center space-x-6">
        ...
        <div className="flex items-center space-x-3 border-l border-white/10 pl-6 cursor-pointer">
          <div className="text-right hidden md:block">
            ...
            <div className="text-xs text-aurum-gold">Elite Funded Trader</div>
          </div>
          <div className="w-10 h-10 rounded-full bg-gradient-to-tr from-aurum-gold to-aurum-blue p-[2px]">
