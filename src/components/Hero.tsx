...
export default function Hero() {
  return (
    <section className="relative min-h-[90vh] flex items-center justify-center overflow-hidden pt-20 pb-16">
      ...
      <div className="absolute bottom-[-10%] right-[-5%] w-[400px] h-[400px] bg-aintrade-gold rounded-full mix-blend-screen blur-[150px] opacity-20"></div>
      ...
      <div className="container mx-auto px-6 relative z-10 grid lg:grid-cols-2 gap-12 items-center">
        ...
        >
          <div className="inline-flex items-center space-x-2 px-4 py-2 rounded-full bg-aurum-panel border border-aintrade-gold/20 text-aintrade-gold text-sm font-medium">
          ...
          <h1 className="text-5xl md:text-7xl font-extrabold tracking-tight leading-tight">
            TRADE WITH EDGE. <br />
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-aintrade-goldLight via-aintrade-gold to-yellow-600">
              AMPLIFY CAPITAL.
            </span>
          </h1>
          ...
          <div className="flex flex-col sm:flex-row w-full sm:w-auto space-y-4 sm:space-y-0 sm:space-x-4">
            <button className="flex items-center justify-center space-x-2 px-8 py-4 bg-aintrade-gold text-black font-bold rounded-lg shadow-[0_0_20px_rgba(212,175,55,0.3)] hover:shadow-[0_0_30px_rgba(212,175,55,0.5)] hover:bg-aintrade-goldLight transition-all duration-300">
